...
export const tarotCards: TarotCards[] = [
    ...
    {
      name: `The Lovers (6)`, imgUrl: `/RWS_Tarot_06_Lovers.jpg`,
      description: `Love, union, connection, a relationship, a family bond, romance.`, astro: astro[2]
    },
    {
      name: `The Chariot (7)`, imgUrl: `/RWS_Tarot_07_Chariot.jpg`,
      description: `Moving forward, fierce determination, action, continuing forward to objectives with haste, direction.`,
      astro: astro[3]
    },
    {
      name: `Strength (8)`, imgUrl: `/RWS_Tarot_08_Strength.jpg`,
      description: `Force, self-control, self-mastery, gentle and firm strength, Kindness to self and others.`,
      astro: astro[4]
    },
    {
      name: `The Hermit (9)`, imgUrl: `/RWS_Tarot_09_Hermit.jpg`,
    ...
    {
      name: `Justice(11)`, imgUrl: `/RWS_Tarot_11_Justice.jpg`,
    ...
    {
      name: `Death (13)`, imgUrl: `/RWS_Tarot_13_Death.jpg`,
    ...
    {
      name: `Temperance (14)`, imgUrl: `/RWS_Tarot_14_Temperance.jpg`,
    ...
    },
    {
      ...
      description: `Evil behavior, wrong thinking, hidden aspects of the self;
    ...
    {
      name: `Ace of Cups`, imgUrl: `/Cups01.jpg`,
    ...
    { name: `Three of Cups`, imgUrl: `/Cups03.jpg`, description: `Emotional friendship, celebration and harmony.`, astro: astro[3] },
    {
      name: `Four of Cups`, imgUrl: `/Cups04.jpg`,
      description: `emotional apathy, not getting pulled into emotional offerings or situations, emotionally blocked or aloof.`,
      astro: astro[3]
    },
    {
      name: `Five of Cups`, imgUrl: `/Cups05.jpg`,
  ...
  manages the home and areas of life correctly; caretaker, chef, home decorator.`
   ...
   Pinning down the thought or insight; may be used to defend or to hurt others.`
    ...
    {
      name: `Nine of Swords`, imgUrl: `/Swords09.jpg`,
      description: `mental torment, anxiety and restless thoughts.`,
      astro: astro[2]
    },
    {
      name: `Ten of Swords`, imgUrl: `/Swords10.jpg`,
    ...
    {
      name: `Page of Swords`, imgUrl: `/Swords11.jpg`,
    ...
    {
      name: `King of Swords`, imgUrl: `/Swords14.jpg`,
    ...
    {
      name: `Knight of Wands`, imgUrl: `/Wands12.jpg`,
